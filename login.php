        ...
        <div class="col-sm-6">
            <form action="validate.php" method="post" class="form-control p-3">
                ...
                <div class="col-sm-12 p-3">
                    ...
                    <input type="text" name="user" id="user" class="form-control" placeholder="Type your username" required>
                </div>
                ...
                <div class="col-sm-12 p-3 text-center">
                    <input type="submit" name="action" value="Login" class="btn btn-dark btn-lg w-100">
                </div>

                <div class="col-sm-12 p-3 text-center">
                    <a href="register.php" class="btn btn-link link">I don't have an account</a>
                </div>
            </form>
        </div>
    </main>
